...
import { getWindow } from "./sensor-window";
import {
  ListenerValidation,
  SensorRecord,
  WatcherEvidence,
...
/**
 * Person B's watchers are live — this is no longer the fixture.
 * `lib/watchers.ts` reads this flag to label the source in verify:watchers.
 */
